 ...
 */
    function (a) {
        ...
        a.fn.pin = function (b) {
            ...
            var g = function () {
                for (var c = 0, g = d.length; g > c; c++) {
                    ...
                    if (b.minWidth && f.width() <= b.minWidth)h.parent().is(".pin-wrapper") && h.unwrap(), h.css({
                        ...
                        top: "",
                        position: ""
                    }), b.activeClass && h.removeClass(b.activeClass), e = !0; else {
                        e = !1;
                        var i = b.containerSelector ? h.closest(b.containerSelector) : a(document.body), j = h.offset(), k = i.offset(), l = h.parent().offset();
                        h.parent().is(".pin-wrapper") || h.wrap("<div class='pin-wrapper'>");
                        var m = a.extend({top: 0, bottom: 0}, b.padding || {});
                        h.data("pin", {
                            pad: m,
                            ...
                            parentTop: l.top
                        }), h.css({width: h.outerWidth()}), h.parent().css("height", h.outerHeight())
                    }
                }
            }, h = function () {
                if (!e) {
                    ...
                    for (var g = [], h = 0, i = d.length; i > h; h++) {
                        var j = a(d[h]), k = j.data("pin");
                        if (k) {
                            g.push(j);
                            var l = k.from - k.pad.bottom, m = k.to - k.pad.top;
            ...
            return this.each(function () {
                var b = a(this), c = a(this).data("pin") || {};
        ...
        a.extend({
            smoothScroll: function () {
                !function () {
                    ...
                    function b() {
                        if (!I && document.body) {
                            ...
                            if (J = document.compatMode.indexOf("CSS") >= 0 ? c : b, y = b, a(), top != self)G = !0; else if (e > d && (b.offsetHeight <= d || c.offsetHeight <= d)) {
                                ...
                                f.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + J.scrollHeight + "px", document.body.appendChild(f);
                                var g;
                                A = function () {
                    ...
                    function c() {
                        z && z.disconnect(), o(S, e), o("mousedown", g), o("keydown", f), o("resize", A), o("load", b)
                    }
                    ...
                    function d(a, b, c) {
                        ...
                        if (N.push({
                            ...
                            var g = a === document.body, h = function (d) {
                                ...
                                g ? window.scrollBy(f, i) : (f && (a.scrollLeft += f), i && (a.scrollTop += i)), b || c || (N = []), N.length ? T(h, a, 1e3 / E.frameRate + 1) : O = !1
                            };
                            T(h, a, 0), O = !0
                        }
                    }
                    ...
                    function e(a) {
                        ...
                        return L && (a.wheelDeltaX && s(a.wheelDeltaX, 120) && (f = -120 * (a.wheelDeltaX / Math.abs(a.wheelDeltaX))), a.wheelDeltaY && s(a.wheelDeltaY, 120) && (g = -120 * (a.wheelDeltaY / Math.abs(a.wheelDeltaY)))), f || g || (g = -a.wheelDelta || 0), 1 === a.deltaMode && (f *= 40, g *= 40), !E.touchpadSupport && r(g) ? !0 : (Math.abs(f) > 1.2 && (f *= E.stepSize / 120), Math.abs(g) > 1.2 && (g *= E.stepSize / 120), d(e, f, g), a.preventDefault(), void h())
                    }
                    ...
                    function q(a, b) {
                        a = a > 0 ? 1 : -1, b = b > 0 ? 1 : -1, (H.x !== a || H.y !== b) && (H.x = a, H.y = b, N = [], P = 0)
                    }

                    function r(a) {
                        return a ? (K.length || (K = [a, a, a]), a = Math.abs(a), K.push(a), K.shift(), clearTimeout(C), C = setTimeout(function () {
                            window.localStorage && (localStorage.SS_deltaBuffer = K.join(","))
                        }, 1e3), !t(120) && !t(100)) : void 0
                    }
                    ...
                    function v(a) {
                        var b, c, d;
                        return a *= E.pulseScale, 1 > a ? b = a - (1 - Math.exp(-a)) : (c = Math.exp(-1), a -= 1, d = 1 - Math.exp(-a), b = c + d * (1 - c)), b * E.pulseNormalize
                    }

                    function w(a) {
                        return a >= 1 ? 1 : 0 >= a ? 0 : (1 == E.pulseNormalize && (E.pulseNormalize /= v(1)), v(a))
                    }
                    ...
                    "onwheel" in document.createElement("div") ? S = "wheel" : "onmousewheel" in document.createElement("div") && (S = "mousewheel"), S && _ && (n(S, e), n("mousedown", g), n("load", b)), x.destroy = c, window.SmoothScrollOptions && x(window.SmoothScrollOptions), "function" == typeof define && define.amd ? define(function () {
                        return x
                    }) : "object" == typeof exports ? module.exports = x : window.SmoothScroll = x
                }()
            }
        }), a("html").hasClass("disable-smooth-scroll") || a.smoothScroll()
